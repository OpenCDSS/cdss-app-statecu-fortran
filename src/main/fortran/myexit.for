...
C***************************************************************************
     ...
     : winter wheat.'
      errmsg(33) = 'Crop Characteristic File wrong spring frost method 
     :for spring wheat.'
...
C23456789012345678901234567890123456789012345678901234567890123456789012
      ...
      errmsg(37) =
     :  'File *.wbc # of basins does not match .cmn # basins.'
      ...
      errmsg(41) =
     :  'File *.wbc problem remarks for precipiation weights.'
      ...
      errmsg(45) =
     :  'File *.wbc problem temperature station lat, long, elev.'
     ...
     :  'File *.wpm problem remarks for precipiation weights.'
      ...
      errmsg(58) =
     :  'File *.wpm problem temperature station lat, long, elev.'
      ...
      errmsg(62) =
     :  'The number of structures exceeds the dimensions of DIM_NA.'
     ...
     : needed to compute the spring cutoff.'
      ...
      if(errndx.ge.100) then
            write(*,*) 'Stopping - see log file: ', logfile
            call exit(1)
      endif
