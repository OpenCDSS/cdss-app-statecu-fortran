      ...
      SUBROUTINE XCRAIN(cu,re,ip,npart,nbegmo,nbegda,nendmo,nendda,
     :                  apdep)
...
C   Purpose         : This calculates the monthly effective rainfall.
...
C                     (rn_xco=1); and USBR method (rn_xco=2). If typepre
