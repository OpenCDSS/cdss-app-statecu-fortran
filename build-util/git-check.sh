...
# StateCU product home is relative to the users files in a standard CDSS development files location
productHome="$home2/cdss-dev/StateCU"
# Main repository in a group of repositories for a product
# - this is where the product repository list file will live
mainRepo="${productHome}/git-repos/cdss-app-statecu-fortran"
